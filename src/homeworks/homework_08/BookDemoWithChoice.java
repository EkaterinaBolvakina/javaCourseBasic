...
public class BookDemoWithChoice {
    public static void main(String[] args) {
        ...
        if (util.choice() == 1){
            ...
            System.out.println("Create a book nr.1: ");
            BookAllParameters book1 = util.createBookAllParameters();
            //вывод подробно информацию о книге
            System.out.println("Completely information about book nr.1: ");
            System.out.println(book1);
            System.out.println();
        ...
        if (util.choice() == 1){
            ...
            BookFirstParameters bookFirstParameters = util.createBookAuthorAndTitle();
            BookAllParameters book2 = util.editBookAuthorAndTitle(bookFirstParameters);
            //вывод информацию о книге
            System.out.println("Information about book: ");
            ...
            BookAddParameters bookAddParameters = util.createBookAdditionalInfo();
            BookAllParameters book2add = util.editBookAuthorAndTitleWithAddInfo(bookFirstParameters,bookAddParameters);
            //вывод подробно информацию о книге
            System.out.println("Completely information about book nr.1: ");
            System.out.println(book2add);
